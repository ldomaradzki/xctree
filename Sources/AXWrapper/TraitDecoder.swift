...
public enum TraitDecoder {
    ...
    ///
    /// - Parameter traitsBitmask: The bitmask value from AXTraits attribute
    /// - Returns: Array of trait names present in the bitmask
    public static func decode(_ traitsBitmask: UInt64) -> [String] {
        var traits: [String] = []

        // iOS UIAccessibilityTraits bit positions
